...
class Kumoa:
    def __init__(self, sovelluslogiikka, edellinen_komento) -> None:
        self.sovelluslogiikka = sovelluslogiikka
    ...
    def suorita(self):
        edellinen_komento = self.edellinen_komento()
...
class Kayttoliittyma:
    def __init__(self, sovelluslogiikka, root):
        ...
        self._komennot = {
            ...
            Komento.KUMOA: Kumoa(
                sovelluslogiikka, self._get_edellinen_komento)
        }
    ...
    def _get_edellinen_komento(self):
